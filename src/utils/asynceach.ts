 ...
 */
export function asynceach<T>(events: RunnerEvents, done: RunnerCallback<T>): void;
 ...
 * @param done callback on event runner finished.
 */
export function asynceach<T>(events: RunnerEvents, onErrorHalt: boolean | RunnerCallback<T>, done: RunnerCallback<T>): void;
